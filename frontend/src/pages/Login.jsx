    ...
    <div className="min-h-screen flex items-center justify-center bg-[var(--turtle-bg)] px-4">
      <div className="bg-white rounded-2xl border border-[var(--turtle-border)] p-8 w-full max-w-sm shadow-sm">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          {isRegister && (
            <div>
              <label className="block text-sm font-medium text-[var(--turtle-text)] mb-1">Your Name</label>
              <input
                type="text"
                value={form.name}
          ...
          <div>
            <label className="block text-sm font-medium text-[var(--turtle-text)] mb-1">Email</label>
            <input
              type="email"
              value={form.email}
          ...
          <div>
            <label className="block text-sm font-medium text-[var(--turtle-text)] mb-1">Password</label>
            <input
              type="password"
              value={form.password}
        ...
        <p className="text-center text-sm text-[var(--turtle-text-muted)] mt-4">
